...
app.layout = html.Div([
        ...
        dbc.Row([
            dbc.Col(dcc.Link(children="Time Series",href="/Time_series",id="link1",style = {'font_size':'6em','font-weight':'bolder','text-align': 'center', 'color': "gray"})),
            #html.Br(),
            dbc.Col(dcc.Link(children="Monte Carlo Simulation",href="/MCsimulation",id="link2",style = {'font_size':'6em','font-weight':'bolder','text-align': 'center', 'color': "gray"})),
            #html.Br(),
            dbc.Col(dcc.Link(children="ML Strategies",href="/ML_strategies",id="link3",style = {'font_size':'6em','font-weight':'bolder','text-align': 'center', 'color': "gray"})),
            ],style = {
                'display': 'flex',
